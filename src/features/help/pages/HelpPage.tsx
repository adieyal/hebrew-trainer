  ...
  return (
    <section className="page page--grid">
      <div className="page__intro">
        ...
        <h2>What this trainer is for and how to use it well</h2>
        <p>
      ...
      <section className="surface-card">
        <div className="section-heading">
          <div>
            ...
            <h3>A practice desk, not a course</h3>
          </div>
        </div>
      ...
      <section className="surface-card">
        <div className="section-heading">
          <div>
            ...
            <h3>From sentence bank to focused review</h3>
          </div>
        </div>
        <dl className="detail-grid">
          <div>
            <dt>1. Build a sentence bank</dt>
            <dd>
          ...
          <div>
            <dt>2. Run a practice session</dt>
            <dd>
          ...
          <div>
            <dt>4. Grow future drills automatically</dt>
            <dd>
      ...
      <section className="surface-card">
        <div className="section-heading">
          <div>
            ...
            <h3>How to import sentences</h3>
          </div>
        </div>
        <dl className="detail-grid">
          <div>
            <dt>English prompts</dt>
            <dd>
          ...
          <div>
            <dt>Corrected Hebrew examples</dt>
            <dd>
